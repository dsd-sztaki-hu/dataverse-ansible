...
if not pgOnly:
   ...
   if not (re.search("1.8", java_version) or re.search("11.", java_version)):
      sys.exit("Dataverse requires Java 1.8 or higher. Please install it, or make sure it's in your PATH, and try again")

...
/opt/dv/dataverse-property-files/lang-integrator.py /opt/dv/dataverse-property-files/hu-HU > /opt/dv/Bundle_en.properties
...
/opt/dv/dataverse-property-files/lang-integrator.py /opt/dv/dataverse-property-files/hu-HU/roles > /opt/dv/BuiltInRoles_en.properties
/opt/dv/dataverse-property-files/lang-integrator.py /opt/dv/dataverse-property-files/en-US > /opt/dv/Bundle_hu.properties
...
curl http://localhost:8080/api/admin/settings/:Languages -X PUT -d '[{"locale":"hu", "title":"English"},{ "locale":"en", "title":"Magyar"}]'
